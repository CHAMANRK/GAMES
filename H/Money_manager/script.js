...
window.showPhoneLogin = () => {
    ...
    try {
        ...
        window.loginRecaptcha.render().catch(e => console.warn('reCAPTCHA render:', e));
    } catch(e) {
...
window.sendLoginOTP = async () => {
    ...
    try {
        ...
        if (window.loginRecaptcha) { window.loginRecaptcha.clear(); window.loginRecaptcha = null; }
    }
};
...
window.sendLinkOTP = async () => {
    ...
    try {
        ...
        if (window.linkRecaptcha) { window.linkRecaptcha.clear(); window.linkRecaptcha = null; }
    }
};
...
window.sendForgotOTP = async (phone) => {
    try {
        ...
        window.showToast('❌ ' + e.message, 'error');
        if (window.forgotRecaptcha) { window.forgotRecaptcha.clear(); window.forgotRecaptcha = null; }
    }
};
