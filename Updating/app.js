// ═══════════════════════════════════════════════════════════════
//  app.js — Entry point: sirf event bindings
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  on('cancelMatchBtn','click', async()=>{
    ...
    const { rtdb, MS }         = await import('./js/app-core.js');
  ...
  on('exitMatchConfirm','click',async()=>{ hideExitConfirm(); leaveMatchCleanup(false); showScreen('welcomeScreen'); });
