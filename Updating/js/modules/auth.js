...
// leaveMatchCleanup: dynamic import to break circular dependency (auth -> online-match -> quiz -> auth)
...
export async function doLogout() {
  try { const { leaveMatchCleanup } = await import('./online-match.js'); leaveMatchCleanup(false); } catch(_) {}
  stopUserListener();
